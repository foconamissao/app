...
export function prdScore(item, maxPeso=1){
...
export function prdLabel(score){
  if(score>=4.15)return 'PRD muito alto';
  if(score>=3.35)return 'PRD alto';
  if(score>=2.55)return 'PRD médio';
  return 'PRD baixo';
}
