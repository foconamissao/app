...
import {prdScore,prdLabel,clampLevel} from './prd.js';
...
function renderPreview(){
 ...
 box.innerHTML=`<div class="table-wrap"><table><thead><tr><th></th><th>#</th><th>Classificação</th><th>Enunciado</th><th>PRD</th><th>Card</th><th>Validação</th></tr></thead><tbody>${rows}</tbody></table></div>`;
...
async function importSelected(){
 ...
 const {data,error}=await sb.rpc('importar_pacote_prd',{p_payload:payload});btn.disabled=false;btn.textContent='IMPORTAR SELECIONADAS';
