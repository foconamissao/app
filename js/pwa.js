...
if('serviceWorker' in navigator){
  window.addEventListener('load',()=>navigator.serviceWorker.register('./service-worker.js?v=4.1.0',{updateViaCache:'none'}).then(reg=>reg.update()).catch(err=>console.error('Falha ao atualizar aplicativo:',err)));
}
